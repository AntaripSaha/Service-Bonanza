...
Route::get('register/login-register-user/{name}', 'PublicController@register')->name('user.register');
...
//login route start
Route::post("post", "PublicController@login")->name('do.login');

//register route start
Route::post("register", "PublicController@do_register")->name('do.register');

//otp page route start
Route::get("otp-page/{phone}", "PublicController@otp_page")->name('otp.page');

//otp verify route start
Route::post("otp-verify/{phone}", "PublicController@otp_verify")->name('otp.verify');
...
Route::group(
    ...
    function () {
        ...
        Route::get('admin/service/list/{service_id}', 'ServiceController@adminServiceDetailsList')->name('admin.service.details.list');
        Route::get('admin/service/{id}', 'ServiceController@adminServiceDetails')->name('admin.service.details');
        Route::get('service-payment-approve/{id}', 'ServiceController@adminServicePaymentApprove')->name('admin.service.transaction.approve');
...
Route::group(
    ...
    function () {
        if (Helper::getAccessType() == 'both' || Helper::getAccessType() == 'services') {
            ...
            Route::get('freelancer/service/{id}/{status}/{user_id}', 'FreelancerController@showServiceDetail')->name('ServiceDetail');
        }
...
Route::group(
    ...
    function () {
        ...
        Route::get('employer/dashboard/job/cancel/{id}', 'JobController@cancel_job')->name('employerJobCancel');
        ...
        Route::get('employer/services/{status}', 'EmployerController@showEmployerServices')->name('employer.service.list');
...
Route::group(
    ...
    function () {
        ...
        // Pay All Amount
        Route::post('proposal/all/payment', 'ProposalController@allPay')->name('pay.all');
        ...
        Route::get('user/package/checkout/{id}', 'UserController@checkout')->name("user.package");

        //user package make payment
        Route::post("user/package/checkout/{id}", 'UserController@makePayment')->name("user.package.make.payment");
...
//submit payment
Route::post('payment-process', 'EmployerController@makePayment')->name('job.make.payment');

//hire freelancer
Route::get('hire-freelancer/{id}', 'EmployerController@hireFreelancer')->name('job.hire.freelancer');

//payment approve
Route::post('payment/approve/{id}', 'ProposalController@paymentApproved')->name('payment.approve');
...
Route::post('service-payment-two/{id}', 'ServiceController@servicePaymentTwo')->name('service.payment.two');
...
Route::post('service-payment/{id}/{id2}', 'ServiceController@servicePayment')->name('service.payment');
//Package Payment Approval
Route::post('package/payment/approve/{id}', 'UserController@paymentApproved')->name('package.payment.approve');
