{!! Form::open(['url' => '', 'class' =>'wt-formtheme wt-userform wt-stripe-form', 'id' =>'stripe-form', '@submit.prevent'=>'submitStripeSettings'])!!}
    <div class="wt-location wt-tabsinfo">
        <div class="wt-tabscontenttitle">
            <h2>{{{ trans('Bkash Settings') }}}</h2>
        </div>
        <div class="wt-settingscontent">
            <div class="wt-formtheme wt-userform">
                <div class="form-group">
                    <h5  class="wt-tabscontenttitle" >Bkash Agent Number</h5>
                    {!! Form::text('stripe_key', e($stripe_key), ['class' => 'form-control', 'placeholder' => trans('Bkash Agent Number')]) !!}
                </div>
            </div>
        </div>
        <div class="wt-settingscontent">
            <div class="wt-formtheme wt-userform">
                <div class="form-group">
                    <h5  class="wt-tabscontenttitle"  >Bkash Personal Number</h5>
                    {!! Form::text('stripe_secret', e($stripe_secret), ['class' => 'form-control', 'placeholder' => trans('Bkash Personal Number')]) !!}
                </div>
            </div>
        </div>
        <div class="wt-settingscontent">
