        ...
        <table style="width: 95%; margin: 150px auto 0;font-family: sans-serif;">
            <thead>
                <tr style="text-align: left; border-radius:5px 0 0;">
                    ...
                    <th style="width:10%; padding: 15px 20px;background: #f5f5f5; font-size:14px;">Transaction ID</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="padding: 15px 20px;border-top: 1px solid #e2e2e2; font-size:14px;">{{{ $payout->amount }}} BDT</td>
