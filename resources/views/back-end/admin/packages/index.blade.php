                                            ...
                                            <select name="roles" v-model="user_role" v-on:change="selectedRole(user_role)">
                                                <option value="" disabled="">{{ trans('lang.select_users') }}</option>
                                                    ...
                                                    @foreach ($roles as $key => $role)
                                                     <option value="{{{ $role['id'] }}}">{{$role['name'] === 'freelancer' ? 'Service Provider' : 'Service Seeker'}}</option>
                                                    @endforeach
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($packages as $package)
                                            <tr class="del-{{{ $package->id }}}" v-bind:id="packageID">
                                                <td>{{{ $package->title }}}</td>
                                                <td>{{{ $package->slug }}}</td>
                                                <td>{{{ Helper::getRoleName($package->role_id) === 'freelancer' ? 'Service Provider' : 'Service Seeker'  }}}</td>           
                                                <td>
