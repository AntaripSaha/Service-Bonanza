                    ...
                    <div class="row">
                        ...
                        @if ($access_type == 'jobs' || $access_type== 'both')
                            ...
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-3">
                                <div class="wt-insightsitem wt-dashboardbox">
                                    @php
                                        $item = \App\Item::where("subscriber",Auth::user()->id)->select("product_id")->first();
                                        $package = \App\Package::where("id",$item->product_id)->select("options")->first();
                                    @endphp
                                    <figure class="wt-userlistingimg">
                                    ...
                                    <div class="wt-insightdetails">
                                        <div class="wt-title">
                                            <h3>{{Helper::getTotalJobs('posted')}}/{{ $jobs }}</h3>
                            ...
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-3">
                                <div class="wt-insightsitem wt-dashboardbox">
                                    ...
                                    <div class="wt-insightdetails">
                                        <div class="wt-title">
                                            <h3>{{Helper::getFeatureJobs()}}/{{ $feature_job }}</h3>
