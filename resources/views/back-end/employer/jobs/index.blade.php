												...
												<div class="wt-userlistingcontent">
														...
														@if (!empty($job->price) ||
															...
															<ul class="wt-saveitem-breadcrumb wt-userlisting-breadcrumb">
																...
																@if (!empty($job->location->title))
																	<li><span><img src="{{{asset(Helper::getLocationFlag($job->location->flag))}}}" alt="{{ trans('lang.img') }}"> 
																	{{{ $job->location->title }}}
																...
																<li>
																	<span class="wt-dashboradclock">
																		<img class="wt-job-icon" 
																		@if( $job->service_type == 'Online' )
																		src="{{asset('images/job-icons/job-interview.svg')}}" width="16px"
																		@else
																		src="{{asset('images/job-icons/house.svg')}}" width="16px"
																		@endif
																		>
																		{{ $job->service_type }}
																	</span>
													...
													<div class="wt-rightarea">
														<div class="wt-btnarea">
															...
															<a href="{{ route('employerJobCancel',$job->id) }}" class="wt-btn">Cancel Job</a>
															@endif
