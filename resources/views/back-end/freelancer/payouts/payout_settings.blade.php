                    ...
                    <div class="wt-tabscontent tab-content">
                        ...
                        <div class="wt-settingscontent">
                            ...
                            <form class="wt-formtheme wt-payout-settings la-payout-settings" @submit.prevent="submitPayoutsDetail({{Auth::user()->id}})" id="profile_payout_detail">
                                ...
                                @endphp
                                @if( !empty($payrol['status']) && $payrol['status'] === 'enable' && $pay_key == 'paypal' )
                                <fieldset>
                                        ...
                                        <span class="wt-radio">
                                            ...
                                            <label for="payrols-{{$payrol['id']}}">
                                                <figure class="wt-userlistingimg">
                                                    <img src="{{asset('uploads/settings/payment/bkash.png')}}" alt="">
                                    ...
                                    <div class="fields-wrapper wt-haslayout" v-if="{{$vue_display}}">
                                        <div class="wt-description">
                                            @if ($payrol['id'] == 'paypal')
                                            <p>{{ trans('lang.paypal_payout_id_text') }} <a target="_blank" href="https://www.bkash.com/"> {{ trans('lang.paypal') }} </a> | <a target="_blank" href="https://www.bkash.com/new_account">{{ trans('lang.payout_id_create_acc') }}</a></p>
                                            @endif
                                        </div>
                                        ...
                                        <div class="form-group form-group-half toolip-wrapo">
                                            <input type="{{$field['type']}}" name="payout_settings[{{$key}}]" id="{{$key}}-payrols" class="form-control" placeholder="Add Bkash" value="{{$db_value}}">
                                        </div>
                                        @endforeach
                                        @endif
                                    </div>
