                        ...
                        <div class="row">
                            ...
                            <div id="wt-statistics" class="wt-statistics wt-profilecounter">
                                <div class="wt-statisticcontent wt-countercolor1">
                                    <h3 data-from="0" data-to="{{{ Helper::getProposals($user->id, 'hired')->count() }}}" data-speed="800" data-refresh-interval="03">{{$ongoing_projects}}</h3>
                                    <h4>{{ trans('lang.ongoing_project') }}</h4>
                                </div>
                                <div class="wt-statisticcontent wt-countercolor2">
                                    <h3 data-from="0" data-to="{{{ Helper::getProposals($user->id, 'completed')->count() }}}" data-speed="8000" data-refresh-interval="100">{{{ $completed_projects }}}</h3>
                                ...
                                <div class="wt-statisticcontent wt-countercolor4" {{ !empty($show_earnings) && ($show_earnings !== true && $show_earnings !== 'true') ? 'style=width:100%' : '' }}>
                                    <h3 data-from="0" data-to="{{{ Helper::getProposals($user->id, 'cancelled')->count() }}}" data-speed="800" data-refresh-interval="02">{{{ $cancelled_projects }}}</h3>
                                    <h4>{{ trans('lang.cancelled_projects') }}</h4>
                                </div>
                                <div class="wt-statisticcontent wt-countercolor3" {{ !empty($show_earnings) && ($show_earnings !== true && $show_earnings !== 'true') ? 'style=width:100%' : '' }}>
                                    <h3 data-from="0" data-to="{{{ Helper::getProposals($user->id, 'published')->count() }}}" data-speed="800" data-refresh-interval="02">{{{ $published_projects }}}</h3>
