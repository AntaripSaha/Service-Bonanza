<nav id="wt-nav" class="wt-nav navbar-expand-lg">
    ...
    <div class="collapse navbar-collapse wt-navigation" id="navbarNav">
        <ul class="navbar-nav">
            ...
            <li class="{{!empty($page_has_child) ? 'menu-item-has-children page_item_has_children' : '' }} @if ($pageID == $page->slug ) current-menu-item @endif" style="{{!empty($order) ? 'order:'.$order : 'order:99' }}">
