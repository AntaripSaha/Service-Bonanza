                    ...
                    <div class="wt-rightarea">
                        ...
                        <div class="wt-loginarea">
                           ...
                           <div class="dropdown-menu">
                                ...
                                <h6><a class="dropdown-item" href="{{ route('user.register','freelancer') }}">Service Provider</a></h6>
                                <div class="dropdown-divider"></div>
                                <h6><a class="dropdown-item" href="{{ route('user.register','employer') }}">Service Seeker</a></h6>
                            </div>
                        </div>

                        <div class="wt-loginarea">
                            <div class="wt-loginoption">
                                <a href="javascript:void(0);" id="wt-loginbtn" class="btn btn-info">{{{trans('lang.login') }}}</a>
                                <div class="wt-loginformhold" @if ($errors->has('email') || $errors->has('password')) style="display: block;" @endif>
                                    ...
                                    <form method="POST" action="{{ route('do.login') }}" class="wt-formtheme wt-loginform do-login-form">
                                        @csrf
                                        <fieldset>
                                            <div class="form-group">
                                                <input id="email" type="text" name="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="Email/Phone" required autofocus>
                                                @if ($errors->has('email'))
                        ...
                        <!-- <div class="wt-loginarea">
                            <div class="wt-loginoption">
                                <a href="javascript:void(0);" id="wt-loginbtn" class="btn btn-success">{{{trans('lang.join_now') }}}</a>
                                <div class="wt-loginformhold">
                                    ...
                                    <div>
                                        <div class="form-control">
                                            ...
                                            <h5> <a href="{{ route('user.register','freelancer') }}">Service Provider</a></h5>
                                        </div>
                                        <div class="form-control">
                                            <h5> <a href="{{ route('user.register','employer') }} ">Service Seeker</a> </h5>
                                        </div>
